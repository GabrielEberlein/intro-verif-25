...
// La función se acepta porque siempre se recursa sobre la cola de la lista, 
// F* reconoce que las recursiones de esta forma garantizan termianción sin necesidad de poner un decrease
